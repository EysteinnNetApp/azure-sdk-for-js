 ...
 * @enum {string}
 */
export type CostPropertyType = 'Unavailable' | 'Reported' | 'Projected';
 ...
 * @enum {string}
 */
export type LabStorageType = 'Standard' | 'Premium';
 ...
 * Possible values include: 'UserOwnedLabVmCount', 'LabVmCount', 'LabVmSize', 'GalleryImage',
 * 'UserOwnedLabVmCountInSubnet'
 * @readonly
 * @enum {string}
 */
export type PolicyFactName = 'UserOwnedLabVmCount' | 'LabVmCount' | 'LabVmSize' | 'GalleryImage' | 'UserOwnedLabVmCountInSubnet';
 ...
 * Possible values include: 'LabVmsShutdownTask', 'LabVmsStartupTask', 'LabBillingTask'
 * @readonly
 * @enum {string}
 */
export type TaskType = 'LabVmsShutdownTask' | 'LabVmsStartupTask' | 'LabBillingTask';
 ...
 * @enum {string}
 */
export type SubscriptionNotificationState = 'NotDefined' | 'Registered' | 'Unregistered' | 'Warned' | 'Suspended' | 'Deleted';
