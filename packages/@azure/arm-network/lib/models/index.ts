...
export interface MatchCondition {
  ...
  /**
   * @member {string[]} matchValues Match value
   */
  matchValues: string[];
  /**
...
export interface ApplicationGateway extends Resource {
  ...
  /**
   * @member {WebApplicationFirewallPolicy1} [firewallPolicy] Web application
   * firewall policy.
   */
...
export interface WebApplicationFirewallPolicy1 extends Resource {
  ...
  /**
   * @member {ApplicationGateway[]} [applicationGateways] A collection of
